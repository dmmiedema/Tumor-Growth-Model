...
%% NOTE: This is a version of CGS with a time dependent and stochastich a(t) for a surface mode of growth. In this version the stochastic term is spatially defined and hence fixed over time for eac clone.
...
%% Main Function
function CloneSizes=CGS_time_stoch_a_x(lambda,h)    
