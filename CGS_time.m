...
%% NOTE: This is a version of CGS with time dependent a(t) for a surface mode of growth.
...
%% Main Function
function CloneSizes=CGS_time(lambda,h)    
    ...
    for i=1:Nclones                                                         % Simulate clone growth for Nclones.
        ...
        while t<tmax                                                        % Simulate clone growth until tmax.
            if nc>0                                                         % If number of clonogenic cells in clone is larger than zero: continue simulation.
                ...
                a=(1+2/(lambda*t+10))/2;                                    % Update probability of cell division.
